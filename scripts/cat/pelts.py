...
class Pelt():
    ...
    tortiebases = ['single', 'tabby', 'bengal', 'marbled', 'ticked', 'smoke', 'rosette', 'speckled', 'mackerel',
                'classic', 'sokoke', 'agouti', 'singlestripe', 'masked', 'dotted', 'striped', 'wildcat', 'cheetah', 'lynx', 'ocelot', 'bobtail', 'manedwolf']

    pelt_length = ["short", "medium", "long"]
    eye_colours = ['YELLOW', 'AMBER', 'HAZEL', 'PALEGREEN', 'GREEN', 'BLUE', 'DARKBLUE', 'GREY', 'CYAN', 'EMERALD', 'PALEBLUE', 
        'PALEYELLOW', 'GOLD', 'HEATHERBLUE', 'COPPER', 'SAGE', 'COBALT', 'SUNLITICE', 'GREENYELLOW', 'BRONZE', 'SILVER', 'BERRYBANANA', 'HALLOWEEN', 'MIDNIGHT', 'WORMY', 'COTTONCANDY', 'BLUEHAZEL', 'FALL', 'SUNSETORANGE', 'SUNSETPURPLE', 'MOONSTONE', 'WALNUT', 
        'CHRISTMAS', 'BROWN', 'SUNSETBLUE', 'CEDAR', 'LOBELIA', 'OXIDIZED', 'SNOW', 'DARKPINE', 'FORESTFIRE', 'GOLDMOON', 'ROSE', 'LIGHTFLAME', 'CLOUDY', 'TURQUOISE', 'TROPICALGREEN', 'SWAMP', 'RAINY', 'SEAFOAM', 'AQUAMARINE', 'EARTH', 'RED', 'PUMPKIN', 'LILAC', 
        'PERIWINKLE', 'TROPICALRED', 'POND', 'DIRT', 'VIOLET', 'SUMMERYELLOW', 'SUMMERORANGE', 'AUTUMNHAZEL', 'GALAXY', 'AUTUMNGREEN', 'WINTERBLUE', 'WINTERVIOLET', 'DUSK', 'PEACOCK', 'NEBULA', 'WINTERPURPLE', 'ECLIPSE', 'SPRINGRED', 'SPRINGROSE', 'AURORA', 'AFTERGLOW', 
        'AUTUMNBROWN', 'LIGHTNING', 'SPRINGPINK', 'SUMMERGOLD', 'HUMMINGBIRD', 'ETA', 'CARINA', 'EAGLE', 'GHOSTHEAD', 'LAGOON', 'MILKYWAY', 'SOUL', 'SWAN', 'TARANTULA', 'VEIL', 'SHROUD', 'CARITA', 'SEAFOAM', 'LILAC', 'AZURE', 'STORM', 'RUSSET', 'SAND', 'MIST', 'AMETHYST', 
        'TEMPEST', 'MIDNIGHT', 'HAZE', 'ECLIPSEDDAWN', 'GRIMAURA', 'LOVEMIX', 'ASTRALSPELL', 'SURPRISE', 'VIRIDIAN', 'ARTISTIQUE', 'SPECTRUMBREEZE', 'RADIANTCOMET', 'COSMIAN', 'CHERRYCHARM', 'FIRECRACKER', 'ALLURA', 'DAHLIA', 'STARBELLE', 'SILVERTONGUE', 'JEWELEDSANDS', 
        'MOONLIT', 'MYTHICWIND', 'ZINNIA', 'CRYSTALCORE', 'APPLESWEETS', 'PEACHCOBBLER', 'TITANIA', 'CYPERUS', 'LUNARGARDEN', 'NECTAR', 'CLOUDEDSUNRISE', 'BLAZE', 'STARLITSPECTRUM', 'SHADOWCHARM', 'SUNSETSPARKLE', 'WILDACE', 'SCULPTEDMIND', 'SUGARCOATING', 'OCEANSUNRISE', 
        'CLEARSKIES', 'DARKVISION', 'VOLCANIC', 'STELLARSOUL', 'LIGHTYELLOW', 'LIGHTAMBER', 'LIGHTHAZEL', 'LIGHTPALEGREEN', 'LIGHTGREEN', 'LIGHTBLUE', 'LIGHTDARKBLUE', 'LIGHTGREY', 'LIGHTCYAN', 'LIGHTEMERALD', 'LIGHTHEATHERBLUE', 'LIGHTSUNLITICE', 'LIGHTCOPPER', 'LIGHTSAGE', 
        'LIGHTCOBALT', 'LIGHTPALEBLUE', 'LIGHTBRONZE', 'LIGHTSILVER', 'LIGHTPALEYELLOW', 'LIGHTGOLD', 'LIGHTGREENYELLOW']
    yellow_eyes = ['YELLOW', 'AMBER', 'PALEYELLOW', 'GOLD', 'COPPER', 'GREENYELLOW', 'BRONZE', 'SILVER', 'BERRYBANANA', 'WORMY', 'SUNSETORANGE', 'WALNUT', 'BROWN', 'CEDAR', 'FORESTFIRE', 'GOL MOON', 'FALL', 'LIGHTFLAME', 'PUMPKIN', 'RED', 'DIRT', 'ROSE', 'TROPICALRED', 'SUMMERYELLOW',  
                   'SUMMERORANGE', 'DUSK', 'ECLIPSE', 'SPRINGRED', 'SPRINGROSE', 'AUTUMNBROWN', 'LIGHTNING', 'SPRINGPINK', 'SUMMERGOLD', 'ETA', 'CARINA', 'GHOSTHEAD', 'RUSSET', 'SAND', 'MIST', 'ECLIPSEDDAWN', 'GRIMAURA', 'LOVEMIX', 'CHERRYCHARM','ALLURA', 'DAHLIA', 'STARBELLE', 'ZINNIA', 
                   'CRYSTALCORE', 'APPLESWEETS', 'PEACHCOBBLER', 'BLAZE','SUNSETSPARKLE', 'OCEANSUNRISE', 'VOLCANIC', 'LIGHTYELLOW', 'LIGHTAMBER', 'LIGHTCOPPER', 'LIGHTBRONZE', 'LIGHTPALEYELLOW', 'LIGHTGOLD', 'LIGHTGREENYELLOW']
    blue_eyes = ['BLUE', 'DARKBLUE', 'CYAN', 'PALEBLUE', 'HEATHERBLUE', 'COBALT', 'SUNLITICE', 'GREY', 'BLUE HAZEL', 'HALLOWEEN', 'MOONSTONE', 'SUNSETBLUE', 'COTTONCANDY', 'MIDNIGHT', 'SNOW', 'SUNSETPURPLE', 'LOBELIA', 'SEAFOAM', 'RAINY', 'CLOUDY', 'POND', 'GALAXY', 'WINTERBLUE', 'WINTERVIOLET', 
                 'PEACOCK', 'WINTERPURPLE', 'AFTERGLOW', 'EAGLE', 'MILKYWAY', 'SOUL', 'SWAN', 'TARANTULA', 'VEIL', 'SHROUD', 'CARITA', 'LILAC', 'AZURE', 'STORM', 'AMETHYST', 'TEMPEST', 'HAZE', 'ASTRALSPELL', 'SURPRISE', 'ARTISTIQUE', 'SPECTRUMBREEZE', 'RADIANTCOMET', 'FIRECRACKER', 'SILVERTONGUE', 
                 'JEWELEDSANDS', 'MOONLIT', 'CLOUDEDSUNRISE', 'STARLITSPECTRUM', 'WILDACE', 'SUGARCOATING', 'CLEARSKIES', 'LIGHTBLUE', 'LIGHTDARKBLUE', 'LIGHTGREY', 'LIGHTCYAN', 'LIGHTHEATHERBLUE', 'LIGHTSUNLITICE', 'LIGHTCOBALT', 'LIGHTPALEBLUE', 'LIGHTSILVER',]
    green_eyes = ['PALEGREEN', 'GREEN', 'EMERALD', 'SAGE', 'HAZEL', 'CHRISTMAS', 'DARKPINE', 'SWAMP', 'EARTH', 'TURQUOISE', 'AQUAMARINE', 'TROPICALGREEN', 'OXIDIZED', 'AUTUMNHAZEL', 'AUTUMNGREEN', 'NEBULA', 'AURORA', 'HUMMINGBIRD', 'LAGOON', 'SEAFOAM', 'MIDNIGHT', 'VIRIDIAN', 'COSMIAN', 'MYTHICWIND', 'TITANIA', 
                  'CYPERUS', 'LUNARGARDEN', 'NECTAR', 'SHADOWCHARM', 'SCULPTEDMIND', 'DARKVISION', 'STELLARSOUL', 'LIGHTHAZEL', 'LIGHTPALEGREEN', 'LIGHTGREEN', 'LIGHTEMERALD', 'LIGHTSAGE']
    ...
    wild_accessories = ["RED FEATHERS", "BLUE FEATHERS", "JAY FEATHERS", "MOTH WINGS", "CICADA WINGS", 
                        ...
                        "LARGE LUNA", "LARGE COMET", "SMALL LUNA", "MORPHO BUTTERFLY", "MUD PAWS",
                        
                        "ORANGEBUTTERFLY", "BLUEBUTTERFLY", "BROWNPELT", "GRAYPELT", "BROWNMOSSPELT", "GRAYMOSSPELT", "FERN", 
                        "MOREFERN", "BLEEDINGHEART", "LILY", "YELLOWCROWN", "REDCROWN", "LILYPADCROWN", "WOODDRAGON", 
                        "CHERRYBLOSSOM","TULIPPETALS","CLOVERFLOWER", "PANSIES","BELLFLOWERS","SANVITALIAFLOWERS","EGGSHELLS",
                        "BLUEEGGSHELLS","EASTEREGG","FORSYTHIA", "MINTLEAF","STICKS", "SPRINGFEATHERS","SNAILSHELL","MUD",
                        "CHERRYPLUMLEAVES","CATKIN","HONEYCOMB","FLOWERCROWN","LILIESOFTHEVALLEY", "STRAWMANE","MISTLETOE",
                        "REDPOINSETTIA","WHITEPOINSETTIA","COTONEASTERWREATH","YEWS","HEATHER","TEETHCOLLAR",
                        "DRIEDORANGE","ROESKULL", "WOODENOAKANTLERS","WOODENBIRCHANTLERS","DOGWOOD","GRAYWOOL","BLACKWOOL","CREAMWOOL",
                        "WHITEWOOL","FIRBRANCHES","CORALBELLS","SILVERDUSTPLANT"]
    ...
    collars = [
        ...
        "REDHARNESS", "NAVYHARNESS", "YELLOWHARNESS", "TEALHARNESS", "ORANGEHARNESS", "GREENHARNESS","MOSSHARNESS", "RAINBOWHARNESS", 
        "BLACKHARNESS", "BEEHARNESS", "CREAMHARNESS","PINKHARNESS", "MAGENTAHARNESS", "PEACHHARNESS", "VIOLETHARNESS"
    ]
    ...
    flower_accessories = ["DAISY", "DIANTHUS", "BLEEDING HEARTS", "FRANGIPANI", "BLUE GLORY",
                          ...
                          "BLUEFLOWERCROWN", "PURPLEFLOWERCROWN"]
    ...
    crafted_accessories = ["WILLOWBARK BAG", "CLAY DAISY POT", "CLAY AMANITA POT", "CLAY BROWNCAP POT", "BIRD SKULL", "LEAF BOW", 
                           ...
                           "LUNARCHIMES", "STARCHIMES", "SILVERLUNARCHIMES", "FIDDLEHEADS", "LANTERNS", "HEARTCHARMS", "CHIMES"]

    tail2_accessories = ["SEAWEED", "DAISY CORSAGE"]

    tabbies = ["Tabby", "Ticked", "Mackerel", "Classic", "Sokoke", "Agouti", "Striped"]
    spotted = ["Speckled", "Rosette", "Cheetah", "Ocelot", "Lynx", "Dotted", "Bobtail"]
    plain = ["SingleColour", "TwoColour", "Smoke", "Singlestripe"]
    exotic = ["Bengal", "Marbled", "Masked", "Wildcat", "Manedwolf"]
    ...
    eye_sprites = [
        ...
        'PALEYELLOW', 'GOLD', 'HEATHERBLUE', 'COPPER', 'SAGE', 'COBALT', 'SUNLITICE', 'GREENYELLOW', 'BRONZE', 'SILVER', 'BERRYBANANA', 'HALLOWEEN', 'MIDNIGHT', 'WORMY', 'COTTONCANDY', 'BLUEHAZEL', 'FALL', 'SUNSETORANGE', 'SUNSETPURPLE', 'MOONSTONE', 'WALNUT', 
        'CHRISTMAS', 'BROWN', 'SUNSETBLUE', 'CEDAR', 'LOBELIA', 'OXIDIZED', 'SNOW', 'DARKPINE', 'FORESTFIRE', 'GOLD MOON', 'ROSE', 'LIGHTFLAME', 'CLOUDY', 'TURQUOISE', 'TROPICALGREEN', 'SWAMP', 'RAINY', 'SEAFOAM', 'AQUAMARINE', 'EARTH', 'RED', 'PUMPKIN', 'LILAC', 
        'PERIWINKLE', 'TROPICALRED', 'POND', 'DIRT', 'VIOLET', 'SUMMERYELLOW', 'SUMMERORANGE', 'AUTUMNHAZEL', 'GALAXY', 'AUTUMNGREEN', 'WINTERBLUE', 'WINTERVIOLET', 'DUSK', 'PEACOCK', 'NEBULA', 'WINTERPURPLE', 'ECLIPSE', 'SPRINGRED', 'SPRINGROSE', 'AURORA', 'AFTERGLOW', 
        'AUTUMNBROWN', 'LIGHTNING', 'SPRINGPINK', 'SUMMERGOLD', 'HUMMINGBIRD', 'ETA', 'CARINA', 'EAGLE', 'GHOSTHEAD', 'LAGOON', 'MILKYWAY', 'SOUL', 'SWAN', 'TARANTULA', 'VEIL', 'SHROUD', 'CARITA', 'SEAFOAM', 'LILAC', 'AZURE', 'STORM', 'RUSSET', 'SAND', 'MIST', 'AMETHYST', 
        'TEMPEST', 'MIDNIGHT', 'HAZE', 'ECLIPSEDDAWN', 'GRIMAURA', 'LOVEMIX', 'ASTRALSPELL', 'SURPRISE', 'VIRIDIAN', 'ARTISTIQUE', 'SPECTRUMBREEZE', 'RADIANTCOMET', 'COSMIAN', 'CHERRYCHARM', 'FIRECRACKER', 'ALLURA', 'DAHLIA', 'STARBELLE', 'SILVERTONGUE', 'JEWELEDSANDS', 
        'MOONLIT', 'MYTHICWIND', 'ZINNIA', 'CRYSTALCORE', 'APPLESWEETS', 'PEACHCOBBLER', 'TITANIA', 'CYPERUS', 'LUNARGARDEN', 'NECTAR', 'CLOUDEDSUNRISE', 'BLAZE', 'STARLITSPECTRUM', 'SHADOWCHARM', 'SUNSETSPARKLE', 'WILDACE', 'SCULPTEDMIND', 'SUGARCOATING', 'OCEANSUNRISE', 
    ...
    def describe_appearance(cat, short=False):
        ...
        pattern_des = {
            ...
            "Bobtail": "unusually speckled c_n",
            "Ocelot": "unusually speckled c_n"
        }
